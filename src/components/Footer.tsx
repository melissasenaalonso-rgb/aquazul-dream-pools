    ...
    <footer className="bg-secondary text-secondary-foreground font-serif">
        ...
        <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12">
          ...
          <div className="col-span-2 md:col-span-2 lg:col-span-1">
            <div className="flex items-center gap-3 mb-4 md:mb-6">
              <img 
                src={logoAquazul}
                alt="Aquazul"
                className="w-12 h-12 md:w-16 md:h-16 rounded-full shadow-glow"
              />
              <div>
                <h3 className="text-lg md:text-xl font-serif font-bold">Aquazul</h3>
                <p className="text-xs md:text-sm opacity-80">Piscinas e Lagos</p>
              </div>
            </div>
            <p className="text-secondary-foreground/80 mb-4 md:mb-6 text-sm md:text-base">
            ...
            <div className="flex gap-3 md:gap-4">
              <a 
                ...
                className="w-9 h-9 md:w-10 md:h-10 rounded-full bg-primary/20 flex items-center justify-center hover:bg-primary/40 transition-colors"
                aria-label="WhatsApp"
              >
          ...
          <div>
            ...
            <ul className="space-y-2 md:space-y-3">
              {[
                ...
                <li key={service}>
                  <span className="text-secondary-foreground/80 text-sm md:text-base">{service}</span>
                </li>
              ))}
            </ul>
          </div>
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <ul className="space-y-3 md:space-y-4">
              <li>
                <a href="tel:+551147228089" className="flex items-center gap-2 md:gap-3 text-secondary-foreground/80 hover:text-primary transition-colors text-sm md:text-base">
                  <Phone className="w-4 h-4 md:w-5 md:h-5 flex-shrink-0" />
                  (11) 4722-8089
                </a>
              </li>
              <li>
                <a href="mailto:aquazul1655@gmail.com" className="flex items-center gap-2 md:gap-3 text-secondary-foreground/80 hover:text-primary transition-colors text-sm md:text-base">
                  <Mail className="w-4 h-4 md:w-5 md:h-5 flex-shrink-0" />
                  aquazul1655@gmail.com
                </a>
              </li>
              <li className="flex items-start gap-2 md:gap-3 text-secondary-foreground/80 text-sm md:text-base">
                <MapPin className="w-4 h-4 md:w-5 md:h-5 flex-shrink-0 mt-0.5" />
                Mogi das Cruzes - SP e Região
              </li>
              <li>
                <a href="https://wa.me/5511947389962" className="flex items-center gap-2 md:gap-3 text-secondary-foreground/80 hover:text-primary transition-colors text-sm md:text-base">
      ...
      <div className="border-t border-primary-foreground/10">
        <div className="container mx-auto px-4 py-4 md:py-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-3 md:gap-4 text-xs md:text-sm text-secondary-foreground/60">
